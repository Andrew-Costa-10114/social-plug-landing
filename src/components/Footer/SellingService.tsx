...
export default function SellingService() {
  return (
    <div className="min-w-[200px] w-full xl:max-w-[250px] pt-4 border-t border-white/10 sm:border-none sm:pt-0 transition-all duration-300">
      ...
      <div className="md:flex md:flex-col columns-[200px] gap-4 overflow-hidden w-full xl:max-h-[600px]">
